 ...
 * @Last Modified by: 唐云
 * @Last Modified time: 2021-08-05 15:39:54
 */
<template>
  <div>
    <el-form
...
import { createOrEditWarehouse } from '@/api/invoice-management/warehouse'
    ...
    const submit = () => {
      return new Promise((resolve, resject) => {
        formRef.value.validate(async (valid) => {
          if (valid) {
            const res = await createOrEditWarehouse(formData)
