 ...
 * @Last Modified by: 唐云
 * @Last Modified time: 2021-08-05 17:18:05
 仓库管理
 */
<template>
  <div class="home-view">
...
<script>
import { getShop, delShop, getCascader } from '@/api/invoice-management/retail'
...
export default defineComponent({
  ...
  setup() {
    ...
    const {
      ...
      multipleSelectionHandler,
      selectIds
    } = useBaseHooks({ reqFn: getShop, searchData, formDataDefault })
